            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                ...
                <p className="text-white/90 text-sm sm:text-base">
                  Discover our premium features: reinforced snaps, brass grommets, breathable mesh, and more
                </p>
              </div>
              <a
                href="/features"
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Custom corner cut-outs with waterproof liner</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-brand-teal mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700">Inner edges sealed with protective treatment for extra weather defense</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-brand-teal mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
