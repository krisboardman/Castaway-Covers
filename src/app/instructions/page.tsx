          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside text-gray-700 space-y-3">
                ...
                <li>
                  <strong>Position the Cover:</strong> Identify the front of the cover (usually 
                  marked with a tag) and drape it over your furniture
                </li>
                <li>
                ...
                <li>
                  <strong>Secure the Cover:</strong> Fasten all straps, buckles, or drawstrings 
                  to ensure a snug fit
                </li>
                <li>
                  <strong>Check Ventilation:</strong> Ensure air vents are not blocked to allow 
                  proper airflow
                </li>
              </ol>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                ...
                <li>Hose down with water monthly or as needed</li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    Use furniture risers or place a bucket/ball under the cover center to create 
                    a peak for water runoff.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Ensure furniture is dry before covering. Check that vents are unobstructed. 
